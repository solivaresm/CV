...
work <- tribble(
  ...
  "National Audubon Society Enterprise GIS", "Dangermond Fellow", "June", 2023, "Present", NA, "Remote", "One of three fellows in the prestigious Dangermond Fellowship program for the National Audubon Society's Enterprise GIS team in partnership with ESRI aimed to foster the next generation of leaders in the enterprise GIS, science, and nonprofit/conservation sectors.", 
  "National Audubon Society Enterprise GIS", "Dangermond Fellow", "June", 2023, "Present", NA, "Remote", "Designs, develops, and implements GIS-based decision support tools (web & mobile maps/apps) to internal stakeholders, partners, and the public using the full Esri suite (including StoryMaps, Hub, Experience Builder, Survey123, Field Maps, etc.)", 
  ...
  "National Audubon Society Enterprise GIS", "Dangermond Fellow", "June", 2023, "Present", NA, "Remote", "Provides consultation and project management to national and regional staff create sustainable GIS solutions for complex issues that help Audubon meet its conservation goals and natural resource management initiatives.", 
  "National Audubon Society Enterprise GIS", "Dangermond Fellow", "June", 2023, "Present", NA, "Remote", "Developed workflow in ArcGIS and Python to upload thousands of sites and conservation actions to our Conservation Hemispheric Insights and Impact Reporting Platform, a product engineered to track the effectiveness of land management practices at our centers and sanctuaries. ", 
  ...
  "Sonoran Desert Inventory & Monitoring Network", "Data Science Intern", "June", 2022, "June", 2023, "Tucson, AZ", "Developed curriculum, communication materials, and online resources as co-leader of SWNC’s R Training series to expand and strengthen integration of data science in the network.", 
  "Sonoran Desert Inventory & Monitoring Network", "Data Science Intern", "June", 2022, "June", 2023, "Tucson, AZ", "Facilitated R training webinars and held biweekly office hours to cultivate community of practice.", 
  "Sonoran Desert Inventory & Monitoring Network", "Data Science Intern", "June", 2022, "June", 2023, "Tucson, AZ", "Provided education and outreach for SIP program as panel speaker for SIP webinar 'Becoming an SIP Intern'.", 
  ...
  "Sonoran Desert Inventory & Monitoring Network", "Data Science Intern", "June", 2022, "June", 2023, "Tucson, AZ", "Presented research poster and StoryMap on Big Rivers data processing workflow at the Geological Society of America's Rocky Mountain Sectional Meeting.",
  ...
  "Haverford College Office of Admissions","Access and Diversity Intern | Admissions Office Fellow | Student Admissions Advisory Committee Member ", "August", 2019, "May", 2022, "Ardmore, PA", "Appointed to Student Admissions Advisory Committee responsible for the recruitment and training of new Admissions Fellows.",
