...
work <- tribble(
  ...
  "Sonoran Desert Inventory & Monitoring Network", "Data Science Intern", "June", 2022, "June", 2023, "Tucson, AZ", "Presented research poster and StoryMap on Big Rivers data processing workflow at the Geological Society of America's Rockuy Mountain Sectional Meeting ",
